# ResNet, fixed resblock width, varying number of resblocks without WN
import numpy as np
import tqdm
...
for scaled in [ False,True]: # True is using proposed WN initialization, False for traditional WN
    file_name="results/resnet_varyB_init-{}_N{}_n{}_m{}_WN-0_scaled-{}.pkl".format(init,N,n,m,int(scaled))
    print(file_name)
